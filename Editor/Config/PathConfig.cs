...
{
    // Excel相关路径
    public string excelPath = Application.dataPath + "/唐老师框架迭代版/Excel表数据/";
    public string dataClassPath = Application.dataPath + "/唐老师框架迭代版/Runtime/ExcelData工具/DataClass/";
    public string dataContainerPath = Application.dataPath + "/唐老师框架迭代版/Runtime/ExcelData工具/Container/";
    ...
    // 配置文件路径
    private static string configFilePath = Application.dataPath + "/唐老师框架迭代版/Editor/Config/PathConfig.json";
