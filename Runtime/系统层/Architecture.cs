...
public class Architecture : BaseManager<Architecture>
{
    ...
    public void AddEventListener(E_EventType eventType, UnityEngine.Events.UnityAction action)
    {
    ...
    /// <param name="eventType">事件类型</param>
    /// <param name="action">事件处理函数</param>
    public void AddEventListener<T>(E_EventType eventType, UnityEngine.Events.UnityAction<T> action)
    {
        EventCenter.Instance.AddEventListener(eventType, action);
    }
    ...
    /// <param name="eventType">事件类型</param>
    /// <param name="action">事件处理函数</param>
    public void RemoveEventListener(E_EventType eventType, UnityEngine.Events.UnityAction action)
    {
    ...
    /// <param name="eventType">事件类型</param>
    /// <param name="action">事件处理函数</param>
    public void RemoveEventListener<T>(E_EventType eventType, UnityEngine.Events.UnityAction<T> action)
    {
        EventCenter.Instance.RemoveEventListener(eventType, action);
    }
