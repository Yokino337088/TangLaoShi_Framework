...
public class ABUpdateMgr : BaseManager<ABUpdateMgr>
{
    ...
    public void CheckUpdate(UnityAction<bool> overCallBack, UnityAction<string> updateInfoCallBack, UnityAction<float> updateSizeCallBack = null,UnityAction<float> updatePro=null)
    {
    ...
    public async void GetLocalABCompareFileInfo(UnityAction<bool> overCallBack)
    {
        // 首先尝试从持久化目录获取对比文件
    ...
    public async void DownLoadABFile(UnityAction<bool> overCallBack, UnityAction<float> updatePro)
    {
        string localPath = Application.persistentDataPath + "/";
        bool isOver = false;
