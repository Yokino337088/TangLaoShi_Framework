...
public class MusicMgr : BaseManager<MusicMgr>
{
    ...
    private MusicMgr() 
    {
        ...
        SceneMgr.Instance.AddSceneLoadStartListener(OnSceneLoadStart);
        SceneMgr.Instance.AddSceneLoadCompleteListener(OnSceneLoadComplete);
    }
    ...
    public void PlaySound(string abName,string soundName, bool isLoop = false, bool isSync = false, UnityAction<AudioSource> callBack = null)
    {
        //加载音效资源，异步加载
    ...
    /// <param name="isSync">是否同步加载</param>
    /// <param name="callBack">播放完成后的回调</param>
    public void PlaySoundSafe(string name, bool isLoop = false, bool isSync = false, UnityAction<AudioSource> callBack = null)
    {
        //如果正在场景加载中，延迟播放
    ...
    /// <param name="isSync"></param>
    /// <param name="callBack"></param>
    public void PlaySoundSafe(string abName, string soundName, bool isLoop = false, bool isSync = false, UnityAction<AudioSource> callBack = null)
    {
        //如果正在场景加载中，延迟播放
        if (isSceneChanging && !isSync)
        {
