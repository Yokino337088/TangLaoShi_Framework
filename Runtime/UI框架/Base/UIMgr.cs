...
public class UIMgr : BaseManager<UIMgr>
{
    ...
    public void ShowPanel<T>(E_UILayer layer = E_UILayer.Middle,  UnityAction<T> callBack = null, string abName = "ui", bool isSync = false) where T:BasePanel
    {
        //获取面板名 预设体名必须和面板类名一致 
    ...
    public void HidePanelWithAnimation<T>(E_HideType hideType,float duration = 0.5f, Action onComplete = null) where T: BasePanel
    {
