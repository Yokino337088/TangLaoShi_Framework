...
public class SceneMgr : BaseManager<SceneMgr>
{
    ...
    private UnityAction onSceneLoadStart;
    private UnityAction onSceneLoadComplete;
    ...
    //异步切换场景的方法
    public async void LoadSceneAsyn(string name, UnityAction callBack = null)
    {
        await ReallyLoadSceneAsyn(name, callBack);
    }

    private async UniTask ReallyLoadSceneAsyn(string name, UnityAction callBack)
    {
        //先清除对象池
    ...
    public void AddSceneLoadStartListener(UnityAction callBack)
    {
        onSceneLoadStart += callBack;
    }

    public void AddSceneLoadCompleteListener(UnityAction callBack)
    {
